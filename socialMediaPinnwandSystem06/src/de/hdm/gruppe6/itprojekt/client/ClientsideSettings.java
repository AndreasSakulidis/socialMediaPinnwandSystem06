...
import de.hdm.gruppe6.itprojekt.shared.CommonSettings;
...
public class ClientsideSettings  extends CommonSettings {
	  ...
	  private static PinnwandVerwaltungServiceAsync pinnwandVerwaltung = null;
	   ...
	   */
	  private static final String LOGGER_NAME = "SocialMediaPinnwandSystem06 Web Client";
	   ...
	   * @since 28.02.2012
	   */
	  public static PinnwandVerwaltungServiceAsync getPinnwandVerwaltung() {
	    ...
	    if (pinnwandVerwaltung == null) {
	      ...
	      pinnwandVerwaltung = GWT.create(PinnwandVerwaltungService.class);
	    }
